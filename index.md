...
### パーソナルデータの分散管理技術に基づく個人最適化型支援サービス（個人研究）
...
### 電子カルテシステムを活用した鍼灸院における筋骨格痛患者の症例データベース構築（国内共同研究・クラウドファンディングによる実施）
...
### 「うつ病、パニック障害、双極性障害の体験を歌にして届けたい！」（個人／アート・クラウドファンディングプロジェクト）
